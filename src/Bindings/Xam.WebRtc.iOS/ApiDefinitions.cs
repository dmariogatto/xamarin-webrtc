...
*/
	...
	interface RTCCVPixelBuffer : IRTCVideoFrameBuffer
	{
		...
		unsafe IntPtr Constructor(ref CVPixelBuffer pixelBuffer);
		...
		unsafe IntPtr Constructor(ref CVPixelBuffer pixelBuffer, int adaptedWidth, int adaptedHeight, int cropWidth, int cropHeight, int cropX, int cropY);
...
*/
	...
	interface RTCYUVPlanarBuffer : RTCVideoFrameBuffer
	{
		...
		unsafe IntPtr InitWithWidth(int width, int height, IntPtr dataY, IntPtr dataU, IntPtr dataV);
...
*/
	...
	interface RTCRtpTransceiver
	{
		...
		unsafe bool CurrentDirection(ref RTCRtpTransceiverDirection currentDirectionOut);
